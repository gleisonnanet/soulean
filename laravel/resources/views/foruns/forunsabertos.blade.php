...
<div class="panel panel-default">
    ...
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title">Fóruns Abertos</h3>
    ...
    <!--tabela -->
      ...
      <!--./tabela -->
            ...
            <tr role="row" class="odd">
                    <td class="sorting_1">Nome do Tema </td>
                    <td>Categoria</td>
                    <td>Tokyo</td>
                    <td>2008/11/28</td>
                    <td>2008/11/28</td>
        ...
        </table><div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Mostrando de 1 a 10 de 2 inscrições</div><div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate"><a class="paginate_button previous disabled" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" id="DataTables_Table_0_previous">Anterior</a>
          <span>
            ...
            <a class="paginate_button " aria-controls="DataTables_Table_0" data-dt-idx="6" tabindex="0">6</a></span>
            <a class="paginate_button next" aria-controls="DataTables_Table_0" data-dt-idx="7" tabindex="0" id="DataTables_Table_0_next">Próximo</a></div></div>
    </div>
  </div>
